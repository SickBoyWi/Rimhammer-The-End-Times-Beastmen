...
{
    public class JobDriver_PutBrineIntoSmoker : JobDriver
    {
        private const TargetIndex BuildingInd = TargetIndex.A;
        private const TargetIndex StuffInd = TargetIndex.B;
        private const int Duration = 200;

        protected Building_MeatSmoker buildingCurrent => (Building_MeatSmoker)this.job.GetTarget(BuildingInd).Thing;
        ...
        protected override IEnumerable<Toil> MakeNewToils()
        {
            ...
            Toil reserveBrine = Toils_Reserve.Reserve(StuffInd, 1, -1, null);
            yield return reserveBrine;
            ...
            yield return Toils_Haul.CheckForGetOpportunityDuplicate(reserveBrine, StuffInd, TargetIndex.None, true, null);
