    ...
    public class Building_MeatSmoker : Building
    {
        ...
        public override string GetInspectString()
        {
            ...
            if (!this.Empty && !comp.Ruined)
            {
                if (this.Ready)
                {
                    stringBuilder.AppendLine("RH_TET_Beastmen_ContainsSmokingMeat".Translate(new object[]
                    {
                        this.stuffCount,
                        MaxCapacity
                    }));
                ...
                {
                    stringBuilder.AppendLine("RH_TET_Beastmen_ContainsSmoking".Translate(new object[]
                    {
                        this.stuffCount,
                        MaxCapacity
                    }));
            ...
            if (!this.Empty)
            {
                if (this.Ready)
                {
                    stringBuilder.AppendLine("RH_TET_Beastmen_Smoked".Translate());
                }
                else
                {
                    stringBuilder.AppendLine("RH_TET_Beastmen_SmokingProgress".Translate(new object[]
                    {
                    ...
                    {
                        stringBuilder.AppendLine("RH_TET_Beastmen_SmokerOutOfIdealTemperature".Translate(new object[]
                        {
            ...
            {
                "RH_TET_Beastmen_IdealSmokingTemperature".Translate(),
                ": ",
