...
{
    public class JobDriver_TakeBrinedMeatFromSmoker : JobDriver
    {
        ...
        protected Building_MeatSmoker BuildingToUse =>
            (Building_MeatSmoker)job.GetTarget(BuildingInd).Thing;
