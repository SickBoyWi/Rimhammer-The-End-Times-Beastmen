...
namespace TheEndTimes_Beastmen
{
    ...
    {
        public override ThingRequest PotentialWorkThingRequest => ThingRequest.ForDef(ThingDef.Named("RH_TET_Beastmen_MeatSmoker"));
        ...
        public static void Reset()
        {
            ...
            NoBrineTrans = "RH_TET_Beastmen_NoBrinedMeat".Translate();
        }
        ...
        public override Job JobOnThing(Pawn pawn, Thing t, bool forced = false)
        {
            ...
            return new Job(DefDatabase<JobDef>.GetNamed("RH_TET_Beastmen_PutBrineIntoSmoker"), t, t2);
        }
