...
{
    public class Graphic_FlickerCustom : Graphic_Collection
    {
          ...
          float extraRotation)
        {
            ...
            {
                Log.ErrorOnce("Graphic_FlickerCustom has no subgraphics " + (object)thingDef, 358773632, false);
            }
            else
            {
